...
public class ProductCategoryController(ApplicationDbContext _ctx, ILogger<ProductCategoryController> _logger) : ControllerBase
{
    private readonly ILogger<ProductCategoryController> logger = _logger;
